...
app.config(function($routeProvider){
  ...
  //the home display
    ...
    //the single player display
    .when('/Connect4Computer', {
      templateUrl: 'Connect4Computer.html',
      controller: 'mainController'
    })
    ...
    //the toot-otto human display
    .when('/TootOttoHuman', {
      templateUrl: 'TootOttoHuman.html',
      controller: 'tootHumanController'
    })

    //the toot-otto computer display
    .when('/TootOttoComputer', {
      templateUrl: 'TootOttoComputer.html',
      controller: 'tootComputerController'
    })

    //the how to otto-toot display
    .when('/HowToToot', {
      templateUrl: 'HowToToot.html',
      controller: 'mainController'
    })

    //the how to otto-toot display
    .when('/HowToConnect4', {
      templateUrl: 'HowToConnect4.html',
      controller: 'mainController'
    })

    //the two players display
    .when('/Connect4Human', {
      templateUrl: 'Connect4Human.html',
...
app.controller('mainController', function(postService, $scope, $rootScope){
	...
	$scope.games=[];
	$scope.newGame= {gameNumber:'100', gameType:'Connect-4', Player1Name: '', Player2Name: 'Computer', WinnerName: '', GameDate: Date.now()};
